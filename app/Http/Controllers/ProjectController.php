...
{
    public $colors = ['#FF6633', '#FFB399', '#FF33FF', '#FFFF99', '#00B3E6', 
    ...
    public function edit(Project $project)
    {
        ...
        foreach($this->data['projectDesignators'] as $key => $value) {
            $this->data['gantt'][] = [
                'id' => $key,
                'title' => $value->designator->name,
                'name' => $value->designator->name,
                'date_start' => $value->begin_date,
                'date_end' => $value->finish_date,
                'color' => $this->colors[$value->id],
            ];
        }

        // dd($this->data['projectDesignators']);
